...
public class PaginationDTOTest {
	...
	// get TotalPageSize test
		    ...
		    public void testHasNextPage1(){
		        ...
		        assertEquals(expected, dto.isHasNextPage());
		    }
...
//			}
		  ...
		  //hasPreviousPage
		    ...
		    public void testGetHasPreviousPage1(){
		        ...
		        assertEquals(expected, dto.isHasPreviousPage());
		    }
			...
			@Test
			public void testGetcurrentPageNumberNo1() {
				PaginationDTO dto = new PaginationDTO();
				int expected = 0;
			...
			@Test
			public void testGetcurrentPageNumberNo2() {
				PaginationDTO dto = new PaginationDTO();
				int expected = 2147483647;
			...
			@Test
			public void testGetcurrentPageNumberNo3() {
				PaginationDTO dto = new PaginationDTO();
				int expected = -2147483648;
			...
			@Test
			public void testSetcurrentPageNumberNo1() {
				PaginationDTO dto = new PaginationDTO();
				int expected = 0;
			...
			@Test
			public void testSetcurrentPageNumberNo2() {
				PaginationDTO dto = new PaginationDTO();
				int expected = 2147483647;
			...
			@Test
			public void testSetcurrentPageNumberNo3() {
				PaginationDTO dto = new PaginationDTO();
				int expected = -2147483648;
