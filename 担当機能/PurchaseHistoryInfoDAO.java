...
public class PurchaseHistoryInfoDAO {
	...
	public List<PurchaseHistoryInfoDTO> getPurchaseHistoryList(String loginId) {
		...
		String sql = "select" + " phi.id as id," + " phi.user_id as user_id," + " phi.product_count as product_count,"
				...
				+ " pi.category_id as category_id," + " pi.price as unit_price," + " pi.image_file_name as image_file_name,"
				...
				+ " phi.destination_id = di.id" + " WHERE phi.user_id = ?" + " ORDER BY regist_date DESC";
